package com.example.projdania.admin;
...
import com.example.projdania.ClASS.Product;
import com.example.projdania.DataTables.DBhelper;
import com.example.projdania.R;
    ...
    public class AddProductActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.addButton) {
                ...
                p = new Product(etname.getText().toString(), etdisc.getText().toString(), data
